...
import { MessageCircle, Phone, Mail, MapPin, Clock, Crown, Gem, Sparkles, Star } from 'lucide-react';
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="bg-glass-white backdrop-blur-glass p-10 rounded-3xl shadow-floating border border-gold border-opacity-30">
            ...
            {/* Typeform Embed */}
            <div className="mb-8 min-h-[600px] bg-silk-white rounded-2xl p-4 border border-gold border-opacity-20">
              <div data-tf-live="01K04N5Q7AC8TBM68RMWDDFMQP"></div>
            </div>
            ...
            <div className="bg-silk-white bg-opacity-50 p-6 rounded-2xl">
              ...
              <p className="text-charcoal-noir font-body text-sm">
                Submit your project details and we'll call you within 24 hours with a luxury solution and premium quote.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-premium-gradient p-8 rounded-3xl text-silk-white text-center shadow-gold-glow">
              ...
              <a
                href="https://wa.me/917303015133?text=Hi%20OPTIMUS%20PROJECTS,%20I%20need%20VIP%20luxury%20construction%20services..."
                target="_blank"
